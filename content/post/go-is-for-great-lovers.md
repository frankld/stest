...
This document is a brief primer on using go templates. The [go docs](http://golang.org/pkg/html/template/) provide more details.
...
A unique characteristic of go templates is they are content aware. Variables and content will be sanitized depending on the context of where they are used. More details can be found in the [go docs](http://golang.org/pkg/html/template/).
